<project xmlns="com.autoesl.autopilot.project" top="fir" name="Project1_FIR128">
    <includePaths/>
    <libraryPaths/>
    <Simulation>
    ...
    <files xmlns="">
        ...
        <file name="../../fir.cpp" sc="0" tb="1" cflags=" -Wno-unknown-pragmas" csimflags=" -Wno-unknown-pragmas" blackbox="false"/>
