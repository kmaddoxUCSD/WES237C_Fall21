...
set id 1
set name fir_mac_muladd_5s_10s_10ns_10_4_1
...
set ce_signed 0
set out_width 10
set arg_lists {i0 {5 1 +} i1 {10 1 +} m {10 1 +} i2 {10 0 +} p {10 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler fir_gmem_m_axi BINDTYPE interface TYPE interface_m_axi
}
